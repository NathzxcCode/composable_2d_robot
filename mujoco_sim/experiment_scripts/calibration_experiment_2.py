...
def main():
    ...
    def generate_n_limbs(n):
        ...
        limbs[0].attach_pos = [0.0, 0.0, 0.1]
        return limbs
        ...
        for sigma_range in Sigma_range:
            for sigma_encoder in Sigma_encoder:
                for movement in Movement_pattern:
                    for opt_iterations in Opt_iterations:
                        states.append((sigma_range, sigma_encoder, window_size, movement, opt_iterations))
    ...
    def controller(qpos, qvel, spos, joint_positions, joint_rotations, t):
        ...
        fg = State["fg"]
        sigma_range, sigma_encoder, window_size, movement, opt_iterations = State["current_state"]
